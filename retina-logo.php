 ...
 * @since   0.1.0
 */
function retlogo_custom_logo_html( $html ) {
...
add_filter( 'get_custom_logo', 'retlogo_custom_logo_html' );
 ...
 * @since   0.1.0
 */
function retlogo_save_logo_sizes( WP_Customize_Setting $setting ) {
...
add_action( 'customize_save_custom_logo', 'retlogo_save_logo_sizes' );
add_action( 'customize_save_custom_logo_is_retina', 'retlogo_save_logo_sizes' );